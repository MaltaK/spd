...
export default class Application extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            tableRows: props.exchangeProgress,
            allRows: props.exchangeProgress,
            tableSort: null,
            intervalCount: 0,
        };
        this.tableColumns = [
            { key: 'time', caption: 'Время', width: 90},
            { key: 'name', caption: 'Имя файла', width: 90},
            { key: 'logical_name', caption: 'Лог. имя', width: 90},
    ...
    componentDidUpdate = prevProps => {
        if (prevProps.exchangeProgress !== this.props.exchangeProgress) {
            this.setState({ tableRows: this.props.exchangeProgress, allRows: this.props.exchangeProgress});
        }
    }
    ...
    handleInputIntervalCount = intervalCount => this.setState({intervalCount})
